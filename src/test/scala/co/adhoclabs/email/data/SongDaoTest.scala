...
import co.adhoclabs.email.models.{AlbumWithSongs, Song}
...
//      }
    ...
    complete {
      ...
      val deleteFutures = List(Future.successful(()))
//        albumsToCreate.map { album =>
...
//
//            val expectedUpdatedSong =
//              expectedSong.copy(title = "updated title", albumId = existingAlbum2.id, albumPosition = 145)
...
//      val expectedSongs: List[Song] =
//        generateSongs(existingAlbum.id, 3) ++ generateSongs(existingAlbum2.id, 3)
