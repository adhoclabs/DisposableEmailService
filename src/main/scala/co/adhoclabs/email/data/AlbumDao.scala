...
import co.adhoclabs.email.data.SlickPostgresProfile.api._
import co.adhoclabs.email.data.SlickPostgresProfile.backend.Database
import co.adhoclabs.email.exceptions.{AlbumAlreadyExistsException, AlbumNotCreatedException}
import co.adhoclabs.email.models.Genre.Genre
import co.adhoclabs.email.models.{Album, AlbumWithSongs, Song}
