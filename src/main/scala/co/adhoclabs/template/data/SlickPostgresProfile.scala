...
trait SlickPostgresProfile extends PostgresProfile with PgDate2Support with PgEnumSupport {
  object PostgresAPI extends API with Date2DateTimePlainImplicits with UuidSupport {
